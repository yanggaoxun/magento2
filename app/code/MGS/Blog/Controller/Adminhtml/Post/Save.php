        ...
        if ($this->getRequest()->getPostValue()) {
            try {
                ...
                if(isset($data['publish_date'])){
                    $model->setPublishedAt($timezone->convertConfigTimeToUtc($data['publish_date']));
                }else{
                    $model->setPublishedAt($this->_objectManager->get('Magento\Framework\Stdlib\DateTime\DateTime')->gmtDate());
                    $model->setUpdatedAt($this->_objectManager->get('Magento\Framework\Stdlib\DateTime\DateTime')->gmtDate());
                }
