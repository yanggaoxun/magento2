 ...
 */
namespace MGS\Mpanel\Block\Panel\Create\Wysiwyg\Images;
...
class Content extends \Magento\Backend\Block\Widget\Container
{
    ...
    {
        return $this->getUrl('mpanel/wysiwyg/contents', ['type' => $this->getRequest()->getParam('type')]);
    }
    ...
    {
        return $this->getUrl('mpanel/wysiwyg/newFolder');
    }
    ...
    {
        return $this->getUrl('mpanel/wysiwyg/deleteFolder');
    }
    ...
    {
        return $this->getUrl('mpanel/wysiwyg/deleteFiles');
    }
    ...
    {
        return $this->getUrl('mpanel/wysiwyg/onInsert');
    }
