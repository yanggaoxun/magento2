...
namespace MGS\Mpanel\Helper\Product;
...
class View extends \Magento\Catalog\Helper\Product\View
{
    ...
    public function initProductLayout(ResultPage $resultPage, $product, $params = null)
    {
		...
		if ($settings->getPageLayout()) {
			...
			$panelLayout = $this->_scopeConfig->getValue('mpanel/product_details/product_layout', \Magento\Store\Model\ScopeInterface::SCOPE_STORE, $this->_storeManager->getStore()->getId());
			if($panelLayout!=''){
